  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-50 to-white p-8 md:p-16">
      ...
      <div className="max-w-6xl mx-auto mb-12">
        ...
        <p className="text-gray-500 mt-2">Koleksi teknologi terbaik untuk membangun masa depan.</p>
      </div>
          ...
          >
            ...
            <div className="space-y-4">
              <div className="flex items-center text-sm text-gray-400">
                ...
                <span className="font-medium text-gray-700">{item.details.developer}</span>
